...
export function confirmSubscribeEmail({ confirmUrl }) {
  return {
    subject: "Confirm your ragbaz updates subscription",
    text: `Confirm you want ragbaz updates (very low volume — only substantial news):\n\n${confirmUrl}\n\nIf this wasn't you, ignore this email.`,
    html: SHELL(
      "Confirm your subscription",
      `<p>Confirm you want ragbaz updates — very low volume, only substantial news.</p>
