...
export const PRODUCTS = [
  ...
  },
  {
    ...
    "pricing": "$12,000–$150,000/year (Appliance / Managed Lab / Enterprise)",
    "revenue": "pre-revenue",
    ...
    "prospect": {
      ...
      "cards": [
        ...
        },
        {
          ...
          "items": [
            "Pricing signal: $12,000–$150,000/year across Appliance, Managed Lab, and Enterprise tiers.",
