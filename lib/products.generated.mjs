// Generated from catalog/products.json — do not edit directly.
...
export const PRODUCTS = [
  {
    ...
    "tag": "building",
    "tagLabel": "building",
    "short": "Pilot-stage policy and evidence control plane for governed AI-agent actions.",
    "value": "Policy-as-code control plane for AI agents with typed action gates, identity-aware access, human approval paths, tamper-evident audit records, independently verifiable evidence packs, and Ed25519 or PKCS#11-backed manifest signing. It supports conformity work; it does not certify a deployment by itself.",
    "pricing": "€25–250/mo per agent",
    "revenue": "pre-revenue",
    "repo": "experiments/BAZ.AI-governance",
    "links": {
      "site": "/#p-governance",
    ...
    "prospect": {
      ...
      "cards": [
        {
          "title": "What is done",
          "intro": "The pilot path is implemented as an executable governance and evidence workflow, not only a specification.",
          "items": [
            "Typed policy gates, identity-aware access, approval queues, audit views, and operator controls are implemented across the control-plane surfaces.",
            "A self-contained buyer demonstration drives allow, hold, approval, and denial decisions and exports a signed real-workload evidence pack for independent verification.",
            "Release, demo, and deployment preflight profiles fail closed on missing requirements; evidence manifests can be signed with Ed25519 or a configured PKCS#11/HSM backend."
          ]
        },
        {
          "title": "What is left",
          "intro": "The remaining gates depend on the target buyer environment and independent review, not another invented compliance percentage.",
          "items": [
            "Run and preserve the validation packet inside the final buyer or operator boundary with buyer-owned identity, retention, key custody, and production integrations.",
            "Obtain buyer legal, security, HA/SLA, and—where applicable—notified-body review of the deployment-specific evidence and residual risks.",
            "Turn the verified pilot deployment into an agreed service scope, support model, and buyer-specific conformity process."
          ]
        },
        {
  ...
  },
  {
    ...
    "tag": "beta",
    "tagLabel": "beta",
    "short": "Containment-first malware sandbox: DetectionOnly WAF tap, Firecracker/Docker isolation, encrypted evidence provenance.",
    "value": "Pilot-stage containment and evidence workflow for hostile web payloads. A DetectionOnly WAF tap fronts a disposable Docker or Firecracker victim; tenant-bound mTLS transports events and samples to an age-encrypted, audited sink with bounded replay and on-demand provenance capture. The current synthetic demo does not claim deterministic request-to-process-to-sample causality.",
    "pricing": "Illustrative, tiered (Self-Hosted / Managed Pilot / Managed Production) — final rates agreed per engagement",
    "revenue": "pre-revenue",
    ...
    "prospect": {
      ...
      "heroCopy": "Containment-first observation for hostile web payloads: a disposable, network-isolated victim, a DetectionOnly WAF tap, and a one-way encrypted evidence trail to an audited sink.",
      "chips": [
        "waf tap",
        "firecracker/docker",
        "evidence provenance"
      ...
      "cards": [
        {
          "title": "What is done",
          "intro": "The core containment, transport, and portable-evidence controls are implemented and exercised in repeatable validation paths.",
          "items": [
            ...
            "Tenant-bound mTLS profiles protect event, sample, and heartbeat transport; the dashboard distinguishes requested protection from runtime-acknowledged active protection.",
            "The buyer workflow exports an encrypted, integrity-checked evidence bundle with offline verification, bounded replay artifacts, and explicit provenance fields."
          ]
        },
        {
          "title": "What is left",
          "intro": "The remaining gates are operational and evidentiary; the current buyer demo remains deliberately synthetic.",
          "items": [
            "Run a customer-owned victim and capture explicit replay/request identifiers plus process and filesystem provenance before claiming deterministic compromise causality.",
            "Complete production key custody and rotation, managed HA cutover operations, and deployment-specific containment review.",
            "Validate multi-sandbox managed-lab scaling and agree the final tiered SKU and support commitments with pilot buyers."
          ]
        },
        {
          "title": "Commercial frame",
          "intro": "This is an enterprise appliance sale, not a self-serve product — pricing and packaging reflect that.",
          "items": [
      ...
      "note": "DetCordon's diligence-grade proof (containment assurance, buyer demo runbook) already exists — see the docs link below before assuming this is early-stage.",
      "ctas": [
        {
          "label": "Request a pilot",
          "href": "mailto:sales@ragbaz.cc?subject=DetCordon%20pilot%20request",
          "primary": true
        },
        {
          "label": "Open product line",
  ...
  },
  {
    ...
    "value": "ESP32 speech-translator firmware — I2S digital microphone input, I2S DAC audio out, OLED (SSD1306) display with rotary encoder menu, Soft-AP web UI for entering API keys and runtime settings. STT, translation, and TTS currently ship as mocked module stubs; wiring them to real API calls or on-device models (ESP-SR / Whisper.cpp, NLLB / tiny-LLM) is the remaining work.",
    "pricing": "—",
    "revenue": "pre-revenue",
    "repo": "products/esp32tolk",
    "links": {
      "site": "/#p-esp32tolk"
    },
    "components": [
