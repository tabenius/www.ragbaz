  ...
  },
  {
    ...
    "prospect": {
      ...
      "cards": [
        {
          "title": "What is done",
          "intro": "The buyer-critical slice is already implemented, not just architected.",
          "items": [
        ...
        {
          "title": "What is left",
          "intro": "The remaining work is production-hardening, not core architecture.",
          "items": [
            "TLS for inter-service event/sample/heartbeat traffic is being carried by generated tenant-bound mTLS profiles; the remaining lift is fleet-wide key custody and rotation.",
